...
#define LOG_TRACE \
    CuteMessageLogger(cuteLoggerInstance(), Logger::Trace, __FILE__, __LINE__, Q_FUNC_INFO).write
#define LOG_DEBUG \
    CuteMessageLogger(cuteLoggerInstance(), Logger::Debug, __FILE__, __LINE__, Q_FUNC_INFO).write
#define LOG_INFO \
    CuteMessageLogger(cuteLoggerInstance(), Logger::Info, __FILE__, __LINE__, Q_FUNC_INFO).write
#define LOG_WARNING \
    CuteMessageLogger(cuteLoggerInstance(), Logger::Warning, __FILE__, __LINE__, Q_FUNC_INFO).write
#define LOG_ERROR \
    CuteMessageLogger(cuteLoggerInstance(), Logger::Error, __FILE__, __LINE__, Q_FUNC_INFO).write
#define LOG_FATAL \
    CuteMessageLogger(cuteLoggerInstance(), Logger::Fatal, __FILE__, __LINE__, Q_FUNC_INFO).write
...
#define LOG_CINFO(category) \
    CuteMessageLogger(cuteLoggerInstance(), Logger::Info, __FILE__, __LINE__, Q_FUNC_INFO, category) \
        .write()
...
#define LOG_TRACE_TIME \
    LoggerTimingHelper loggerTimingHelper(cuteLoggerInstance(), \
                                          Logger::Trace, \
                                          __FILE__, \
                                          __LINE__, \
                                          Q_FUNC_INFO); \
...
#define LOG_ASSERT(cond) \
    ((!(cond)) ? cuteLoggerInstance()->writeAssert(__FILE__, __LINE__, Q_FUNC_INFO, #cond) \
               : qt_noop())
#define LOG_ASSERT_X(cond, msg) \
    ((!(cond)) ? cuteLoggerInstance()->writeAssert(__FILE__, __LINE__, Q_FUNC_INFO, msg) \
               : qt_noop())
...
public:
    CuteMessageLogger(
        Logger *l, Logger::LogLevel level, const char *file, int line, const char *function)
        : m_l(l)
        , m_level(level)
        , m_file(file)
        , m_line(line)
...
public:
    inline explicit LoggerTimingHelper(
        Logger *l, Logger::LogLevel logLevel, const char *file, int line, const char *function)
        : m_logger(l)
        , m_logLevel(logLevel)
